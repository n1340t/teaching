...
void finalGrade(string fName[], string lName[], float g1[], float g2[], float g3[]); // q3
int main()
{
  ...
  finalGrade(fName, lName, g1, g2, g3);
  return 0;
}
...
void finalGrade(string fName[], string lName[], float g1[], float g2[], float g3[])
{
